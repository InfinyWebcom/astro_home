...
class PrivacyPolicy extends Component {
    ...
    componentDidMount = async () => {
        let data = await Axios.axiosHelperFunc('post', 'admin/getContentByName', { name: 'privacy_policy' })
                            ...
                            <div className="col-12 col-md-12 col-lg-12">
                                <div className="login-signup-wrap p-5">
                                    <div className="login-signup-header text-left">
                                        <a href="/"><img style={{ height: '100px', width: 'auto' }} src="assets/img/logo.png" className="img-fluid mb-3" alt="Logo" /></a>
