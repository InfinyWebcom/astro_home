                ...
                <div className="row align-items-center justify-content-md-center">
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-face-smile icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                            ...
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-vector icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                                    <div className="icon-text">
                            ...
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-headphone-alt icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                                    <div className="icon-text">
                    ...
                    <div className="col-lg-4 col-md-12">
                        <div className="row">
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-layout-media-right icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                                    <div className="icon-text">
                            ...
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-layout-cta-right icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                                    <div className="icon-text">
                            ...
                            <div className="col-12">
                                <div className="d-flex align-items-start mb-sm-0 mb-md-5 mb-lg-5">
                                    <span className="ti-palette icon-size-xs p-3 secondary-bg rounded shadow-sm text-white mr-4"></span>
                                    <div className="icon-text">
