export const required = value => {
    ...
    } else if ((value && typeof value === 'number') || (value && typeof value === 'string' && value.trim()) || (value && typeof value === 'object')) {
        return undefined
    } else {
        return 'This field is required'
    }
...
export const validatePinCode = (value) => {
    ...
    console.log('validatePinCode', value, format.test(value))
...
export const validateDate = (value) => {
    ...
    console.log('validateDate', selectedDate < date, selectedDate, date)
